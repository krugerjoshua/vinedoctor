...
const SEVERITY = {
    ...
    medium: { bg: "#FAEEDA", color: "#854F0B", border: "#F0C070", label: "Medium" },
...
export default function DiagnosisResult() {
    ...
    const sev = SEVERITY[current.overall_severity] || SEVERITY.medium;
    ...
    return (
        <div style={{ maxWidth: 600, margin: "0 auto", padding: "1.5rem 1rem 3rem" }}>
            ...
            <div style={{ textAlign: "center", marginBottom: "1.5rem" }}>
                ...
                <p style={{ fontSize: 13, color: "#888", marginTop: 4 }}>Field diagnosis report</p>
            </div>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <span style={{ color: "#EAF3DE", fontSize: 12, letterSpacing: "0.06em", textTransform: "uppercase" }}>
                        Field Report
                    </span>
                    <span style={{
                            ...
                            {current.treatments.map((t, i) => (
                                <div key={i} style={{
                                    ...
                                    <div style={{
                                        ...
                                        <span style={{ fontWeight: 700, fontSize: 14 }}>{t.product}</span>
                                        <span style={{
                                            fontSize: 10,
                                            fontWeight: 600,
                                            background: "#E0EDD5",
                        ...
                        <div key={item.id} style={{
                            ...
                            <div>
                                <div style={{ fontSize: 13, fontWeight: 600 }}>
                                    {item.result.conditions?.[0]?.condition || "Unknown"}
                                </div>
                            ...
                            <span style={{
                                ...
                                borderRadius: 99,
                                whiteSpace: "nowrap",
                                background: (SEVERITY[item.result.overall_severity] || SEVERITY.medium).bg,
                                color: (SEVERITY[item.result.overall_severity] || SEVERITY.medium).color,
                                border: `1px solid ${(SEVERITY[item.result.overall_severity] || SEVERITY.medium).border}`,
                            }}>
                                {item.result.overall_severity}
                            </span>
                        </div>
                    ))}
                </div>
